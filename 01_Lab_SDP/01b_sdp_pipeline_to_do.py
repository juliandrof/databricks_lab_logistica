...
# MAGIC
# MAGIC Neste lab voce vai construir um pipeline SDP (Delta Live Tables) completo para processar dados de logistica.
# MAGIC
# MAGIC **Camadas:**
...
# ║  Dica: Use @dlt.table decorator com name e comment.          ║
# ║        Leia de spark.read.table(f"{catalog_name}.raw.        ║
# ║        movimento_cargas")                                     ║
# ║  Exemplo:                                                     ║
# ║    @dlt.table(name="bronze_movimento_cargas",                 ║
# ║               comment="...",                                  ║
# ║               table_properties={"quality": "bronze"})         ║
